              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: _selectedImage == null
                                  ? Image.asset(AppImages.advertiserprofile)
                                  : ClipOval(
                                child: Image.file(
                    ...
                    Text(  "Jhon Doe",style: TextFontStyle.titleStyle18w500c1C1D20Manrope),

                    Text(  "johndoe@gmail.com",style: TextFontStyle.titleStyle16w400c888E9CManrope),
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text("Subscription Status",style: TextFontStyle.titleStyle32w600c2F2F2FManrope.copyWith(fontSize: 18.sp)),
                      ],
                    ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text("Premium Plan",style: TextFontStyle.titleStyle32w600c2F2F2FManrope.copyWith(fontSize: 18.sp)),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            UIHelper.horizontalSpace(8.w),
                            Text(  "Active", style: TextFontStyle.titleStyle14w500c34A853Manrope),
                    ...
                    CustomButton(
                      color: AppColors.cFF4800,
                        ...
                        onCallBack: () {  NavigationService.navigateTo(Routes.advertiserSubcriptionScreen); },
                        context: context)
                ...
                child: Column(
                  children: [
                    ...
                    ProfileCardSection(
                      ...
                      callback: () {
                        NavigationService.navigateTo(Routes.advertiserEditPersonalInfoScreen);
                      },
                    ),
                    UIHelper.verticalSpace(16.h),
                    ProfileCardSection(
                      ...
                      callback: () {   NavigationService.navigateTo(Routes.advertiserUpdatePasswordScreen);}),
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text("Support",style: TextFontStyle.titleStyle16w600c262629Manrope)),
                    ...
                    ProfileCardSection(
                      ...
                      callback: () {
                        NavigationService.navigateTo(Routes.advertiserHelpCenter);
                      },
                    ),
                    UIHelper.verticalSpace(8.h),
                    ProfileCardSection(
                    ...
                    UIHelper.verticalSpace(16.h),
                    Divider( height: 2, color: AppColors.cFFEDE6,),
