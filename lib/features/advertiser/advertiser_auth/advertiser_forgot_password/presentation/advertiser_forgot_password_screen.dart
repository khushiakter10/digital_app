...
class AdvertiserForgetPasswordScreen extends StatefulWidget {
  const AdvertiserForgetPasswordScreen({super.key});

  @override
  State<AdvertiserForgetPasswordScreen> createState() =>
      _AdvertiserForgetPasswordScreenState();
}

class _AdvertiserForgetPasswordScreenState
    extends State<AdvertiserForgetPasswordScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      NavigationService.navigateToWithArgs(Routes.advertiserForgotOtpVerificationScreen,{
