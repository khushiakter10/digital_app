...
class AdvertiserResetPasswordScreen extends StatefulWidget {
  const AdvertiserResetPasswordScreen({super.key});

  @override
  State<AdvertiserResetPasswordScreen> createState() =>
      _AdvertiserResetPasswordScreenState();
}

class _AdvertiserResetPasswordScreenState
    extends State<AdvertiserResetPasswordScreen> {
  ...
  Future<void> _advertiserReset() async {
    ...
    try {
      NavigationService.navigateToWithArgs(
        Routes.advertiserSubcriptionScreen,
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomButton(
                    ...
                    name: _isLoading ? "Please wait..." : "Next",
                    onCallBack: _advertiserReset,
                    context: context,
