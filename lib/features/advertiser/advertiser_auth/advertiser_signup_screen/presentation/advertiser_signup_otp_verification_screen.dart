...
import 'package:digital_app/features/advertiser/advertiser_auth/advertiser_forgot_password/widget/advertiser_verification_dialog_box.dart';
...
class AdvertiserSignupOtpVerificationScreen extends StatefulWidget {
  const AdvertiserSignupOtpVerificationScreen({super.key, required this.email});
  final String email;

  @override
  State<AdvertiserSignupOtpVerificationScreen> createState() =>
      _AdvertiserSignupOtpVerificationScreenState();
}

class _AdvertiserSignupOtpVerificationScreenState
    extends State<AdvertiserSignupOtpVerificationScreen> {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return VerificationSuccessDialog(
              onVerify: () {
                NavigationService.navigateTo(Routes.advertiserInformationAuthScreen);
