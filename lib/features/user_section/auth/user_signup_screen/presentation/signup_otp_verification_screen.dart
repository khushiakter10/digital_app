...
class UserSignupOtpVerificationScreen extends StatefulWidget {
  const UserSignupOtpVerificationScreen({super.key, required this.email});
  final String email;

  @override
  State<UserSignupOtpVerificationScreen> createState() =>
      _UserSignupOtpVerificationScreenState();
}

class _UserSignupOtpVerificationScreenState
    extends State<UserSignupOtpVerificationScreen> {
