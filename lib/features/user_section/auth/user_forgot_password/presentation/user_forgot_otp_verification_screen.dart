...
class UserForgotOTPVerificationScreen extends StatefulWidget {
  const UserForgotOTPVerificationScreen({super.key, required this.email});
  final String email;

  @override
  State<UserForgotOTPVerificationScreen> createState() =>
      _UserForgotOTPVerificationScreenState();
}

class _UserForgotOTPVerificationScreenState
    extends State<UserForgotOTPVerificationScreen> {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return VerificationSuccessDialog(
              onVerify: () {
                NavigationService.navigateTo(Routes.userResetPasswordScreen);
