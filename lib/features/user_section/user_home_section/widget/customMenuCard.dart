...
class FoodOfferCard extends StatefulWidget {
  const FoodOfferCard({super.key});

  @override
  State<FoodOfferCard> createState() => _FoodOfferCardState();
}

class _FoodOfferCardState extends State<FoodOfferCard> {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.location_on, size: 16, color:AppColors.cFF4800),
                    SizedBox(width: 4),
                    Text('Riyadh', style: TextStyle(fontSize: 12.sp)),
                    SizedBox(width: 10),
                    Icon(Icons.watch_later_outlined, size: 14, color:AppColors.cFF4800),
                    SizedBox(width: 4),
                    Text('Valid until Feb 29', style: TextStyle(fontSize: 12.sp)),
                  ],
                ),
              ],
            ),
