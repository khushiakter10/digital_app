...
class UserEditPersonalInfoScreen extends StatefulWidget {
  const UserEditPersonalInfoScreen({super.key});

  @override
  State<UserEditPersonalInfoScreen> createState() => _UserEditPersonalInfoScreenState();
}

class _UserEditPersonalInfoScreenState extends State<UserEditPersonalInfoScreen> {
...
//--------------------------------------------------- Full Name ------------------------------------------------//
              ...
              Text("Email", style: TextFontStyle.titleStyle16w600c181818Manrope.copyWith(fontSize: 14.sp),),
              UIHelper.verticalSpace(8.h),
              CustomTextfield(
                borderColor: AppColors.cE8E8E8,
                fillColor: AppColors.white,
