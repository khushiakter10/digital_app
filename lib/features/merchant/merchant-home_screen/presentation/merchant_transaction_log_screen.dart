...
class MerchantTransactionLogScreen extends StatefulWidget {
  const MerchantTransactionLogScreen({super.key});

  @override
  State<MerchantTransactionLogScreen> createState() =>
      _MerchantTransactionLogScreenState();
}

class _MerchantTransactionLogScreenState
    extends State<MerchantTransactionLogScreen> {
  @override
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: AppColors.cFFE4D9, width: 1.w),
                      ),
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Image.asset(AppImages.saraProfile,
                                    height: 50.h),
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'saraakter@gmailcom',
                                      style: TextFontStyle
                                          .titleStyle14w500c757575Manrope,
                                    ),
                                    UIHelper.verticalSpace(4.h),
                                    Text(
                                      'SUST-#236555',
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'Fashion Hub ',
                                      style: TextFontStyle
                                          .titleStyle16w600c181818Manrope,
                                    ),
                                    Text(
                                      '25% off ',
                                      style: TextFontStyle
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '4 June 2025, 2:30 PM',
                                  style: TextFontStyle
                                      .titleStyle14w400c757575Manrope,
                                )
                              ],
                            ),
