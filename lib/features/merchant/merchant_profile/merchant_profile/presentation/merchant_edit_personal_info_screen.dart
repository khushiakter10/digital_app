...
class MerchantEditPersonalInfoScreen extends StatefulWidget {
  const MerchantEditPersonalInfoScreen({super.key});

  @override
  State<MerchantEditPersonalInfoScreen> createState() => _MerchantEditPersonalInfoScreenState();
}

class _MerchantEditPersonalInfoScreenState extends State<MerchantEditPersonalInfoScreen> {
  ...
  ///=================Phone Number InputField Function===========
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppbarProfile(title: "Edit Personal Info", iconPath: AppIcons.backArrowIcon, onIconTap: () => NavigationService.goBack,),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ///================== Full Name================
              Text("Full Name", style: TextFontStyle.titleStyle16w500primary2Manrope.copyWith(color: AppColors.c262629,fontWeight: FontWeight.w600
              )),
              ...
              Text(
                "Email",
                style: TextFontStyle.titleStyle16w500primary2Manrope.copyWith(color: AppColors.c262629,fontWeight: FontWeight.w600),
              ),
              UIHelper.verticalSpace(8.h),
              CustomTextfield(
                borderColor: AppColors.cE8E8E8,
