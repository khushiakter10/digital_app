...
import 'package:digital_app/features/merchant/merchant_auth/merchant_forgot_password/widget/merchant_verification_dialog_box.dart';
...
class MerchantForgotOtpVerification extends StatefulWidget {
  const MerchantForgotOtpVerification({super.key, required this.email});
  final String email;

  @override
  State<MerchantForgotOtpVerification> createState() =>
      _MerchantForgotOtpVerificationState();
}

class _MerchantForgotOtpVerificationState
    extends State<MerchantForgotOtpVerification> {
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (BuildContext context) {
            return MerchantVerificationDialogBox(
              onVerify: () {
                NavigationService.navigateTo(Routes.merchantResetPasswordScreen1);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: CustomAppbarProfile(title: "", iconPath: AppIcons.backArrowIcon, onIconTap: () => NavigationService.goBack,showIcon: true,),
