...
class MerchantSignupOtpVerificationScreen extends StatefulWidget {
  const MerchantSignupOtpVerificationScreen({super.key, required this.email});
  final String email;

  @override
  State<MerchantSignupOtpVerificationScreen> createState() =>
      _SignupOtpVerificationScreenState();
}

class _SignupOtpVerificationScreenState
    extends State<MerchantSignupOtpVerificationScreen> {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return VerificationSuccessDialog(
              onVerify: () {
                NavigationService.navigateTo(Routes.merchantInformationScreen); // Close the dialog
